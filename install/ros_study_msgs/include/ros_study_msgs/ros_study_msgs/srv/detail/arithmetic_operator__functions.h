...
#ifndef ROS_STUDY_MSGS__SRV__DETAIL__ARITHMETIC_OPERATOR__FUNCTIONS_H_
#define ROS_STUDY_MSGS__SRV__DETAIL__ARITHMETIC_OPERATOR__FUNCTIONS_H_
 ...
 * calls
 * ros_study_msgs__srv__ArithmeticOperator_Request__init().
...
/**
 * It calls
 * ros_study_msgs__srv__ArithmeticOperator_Request__fini()
 ...
 * ros_study_msgs__srv__ArithmeticOperator_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * ros_study_msgs__srv__ArithmeticOperator_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * ros_study_msgs__srv__ArithmeticOperator_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ros_study_msgs
...
/**
 * It calls
 * ros_study_msgs__srv__ArithmeticOperator_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_ros_study_msgs
...
/**
 * It allocates the memory for the array and calls
 * ros_study_msgs__srv__ArithmeticOperator_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_ros_study_msgs
...
/**
 * It calls
 * ros_study_msgs__srv__ArithmeticOperator_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // ROS_STUDY_MSGS__SRV__DETAIL__ARITHMETIC_OPERATOR__FUNCTIONS_H_
