...
bool ros_study_msgs__msg__arithmetic_argument__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ros_study_msgs.msg._arithmetic_argument.ArithmeticArgument", full_classname_dest, 58) == 0);
  }
  ros_study_msgs__msg__ArithmeticArgument * ros_message = _ros_message;
  {  // stamp
...
PyObject * ros_study_msgs__msg__arithmetic_argument__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ros_study_msgs.msg._arithmetic_argument");
