...
#include "ros_study_msgs/msg/detail/arithmetic_argument__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros_study_msgs::msg::ArithmeticArgument & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_study_msgs::msg::ArithmeticArgument & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_study_msgs::msg::ArithmeticArgument;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros_study_msgs::msg::ArithmeticArgument *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_study_msgs::msg::ArithmeticArgument *>(
    untyped_ros_message);
...
{
  return &ros_study_msgs::msg::typesupport_fastrtps_cpp::_ArithmeticArgument__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_study_msgs, msg, ArithmeticArgument)() {
  return &ros_study_msgs::msg::typesupport_fastrtps_cpp::_ArithmeticArgument__handle;
}
