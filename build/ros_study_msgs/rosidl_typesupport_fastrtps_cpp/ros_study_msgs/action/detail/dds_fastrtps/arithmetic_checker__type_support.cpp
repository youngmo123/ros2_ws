...
#include "ros_study_msgs/action/detail/arithmetic_checker__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ros_study_msgs::action::ArithmeticChecker_Goal & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_study_msgs::action::ArithmeticChecker_Goal & ros_message)
{
  // Member: goal_sum
  cdr >> ros_message.goal_sum;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_study_msgs::action::ArithmeticChecker_Goal;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros_study_msgs::action::ArithmeticChecker_Goal *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ros_study_msgs::action::ArithmeticChecker_Goal *>(
    untyped_ros_message);
...
{
  return &ros_study_msgs::action::typesupport_fastrtps_cpp::_ArithmeticChecker_Goal__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_study_msgs, action, ArithmeticChecker_Goal)() {
  return &ros_study_msgs::action::typesupport_fastrtps_cpp::_ArithmeticChecker_Goal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros_study_msgs
cdr_serialize(
  const ros_study_msgs::action::ArithmeticChecker_Result & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: all_formula
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_study_msgs::action::ArithmeticChecker_Result & ros_message)
{
  // Member: all_formula
  {
    cdr >> ros_message.all_formula;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros_study_msgs::action::ArithmeticChecker_Result;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros_study_msgs::action::ArithmeticChecker_Result *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros_study_msgs::action::ArithmeticChecker_Result *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros_study_msgs::action::typesupport_fastrtps_cpp::_ArithmeticChecker_Result__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_study_msgs, action, ArithmeticChecker_Result)() {
  return &ros_study_msgs::action::typesupport_fastrtps_cpp::_ArithmeticChecker_Result__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros_study_msgs
cdr_serialize(
  const ros_study_msgs::action::ArithmeticChecker_Feedback & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: formula
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_study_msgs::action::ArithmeticChecker_Feedback & ros_message)
{
  // Member: formula
  {
    cdr >> ros_message.formula;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros_study_msgs::action::ArithmeticChecker_Feedback;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros_study_msgs::action::ArithmeticChecker_Feedback *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros_study_msgs::action::ArithmeticChecker_Feedback *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros_study_msgs::action::typesupport_fastrtps_cpp::_ArithmeticChecker_Feedback__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_study_msgs, action, ArithmeticChecker_Feedback)() {
  return &ros_study_msgs::action::typesupport_fastrtps_cpp::_ArithmeticChecker_Feedback__handle;
}
...
// functions for ros_study_msgs::action::ArithmeticChecker_Goal already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros_study_msgs
cdr_serialize(
  const ros_study_msgs::action::ArithmeticChecker_SendGoal_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_study_msgs::action::ArithmeticChecker_SendGoal_Request & ros_message)
{
  // Member: goal_id
  ...
  size_t current_alignment)
{
  ...
  // Member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros_study_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_ArithmeticChecker_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros_study_msgs::action::ArithmeticChecker_SendGoal_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros_study_msgs::action::ArithmeticChecker_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros_study_msgs::action::ArithmeticChecker_SendGoal_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros_study_msgs::action::typesupport_fastrtps_cpp::_ArithmeticChecker_SendGoal_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_study_msgs, action, ArithmeticChecker_SendGoal_Request)() {
  return &ros_study_msgs::action::typesupport_fastrtps_cpp::_ArithmeticChecker_SendGoal_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros_study_msgs
cdr_serialize(
  const ros_study_msgs::action::ArithmeticChecker_SendGoal_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: accepted
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_study_msgs::action::ArithmeticChecker_SendGoal_Response & ros_message)
{
  // Member: accepted
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros_study_msgs::action::ArithmeticChecker_SendGoal_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros_study_msgs::action::ArithmeticChecker_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros_study_msgs::action::ArithmeticChecker_SendGoal_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros_study_msgs::action::typesupport_fastrtps_cpp::_ArithmeticChecker_SendGoal_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_study_msgs, action, ArithmeticChecker_SendGoal_Response)() {
  return &ros_study_msgs::action::typesupport_fastrtps_cpp::_ArithmeticChecker_SendGoal_Response__handle;
}
...
{
  return &ros_study_msgs::action::typesupport_fastrtps_cpp::_ArithmeticChecker_SendGoal__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_study_msgs, action, ArithmeticChecker_SendGoal)() {
  return &ros_study_msgs::action::typesupport_fastrtps_cpp::_ArithmeticChecker_SendGoal__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros_study_msgs
cdr_serialize(
  const ros_study_msgs::action::ArithmeticChecker_GetResult_Request & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_study_msgs::action::ArithmeticChecker_GetResult_Request & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros_study_msgs::action::ArithmeticChecker_GetResult_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros_study_msgs::action::ArithmeticChecker_GetResult_Request *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros_study_msgs::action::ArithmeticChecker_GetResult_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros_study_msgs::action::typesupport_fastrtps_cpp::_ArithmeticChecker_GetResult_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_study_msgs, action, ArithmeticChecker_GetResult_Request)() {
  return &ros_study_msgs::action::typesupport_fastrtps_cpp::_ArithmeticChecker_GetResult_Request__handle;
}
...
// forward declaration of message dependencies and their conversion functions
// functions for ros_study_msgs::action::ArithmeticChecker_Result already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros_study_msgs
cdr_serialize(
  const ros_study_msgs::action::ArithmeticChecker_GetResult_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_study_msgs::action::ArithmeticChecker_GetResult_Response & ros_message)
{
  // Member: status
  cdr >> ros_message.status;
  ...
  size_t current_alignment)
{
  ...
  // Member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros_study_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_ArithmeticChecker_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros_study_msgs::action::ArithmeticChecker_GetResult_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros_study_msgs::action::ArithmeticChecker_GetResult_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros_study_msgs::action::ArithmeticChecker_GetResult_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros_study_msgs::action::typesupport_fastrtps_cpp::_ArithmeticChecker_GetResult_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_study_msgs, action, ArithmeticChecker_GetResult_Response)() {
  return &ros_study_msgs::action::typesupport_fastrtps_cpp::_ArithmeticChecker_GetResult_Response__handle;
}
...
{
  return &ros_study_msgs::action::typesupport_fastrtps_cpp::_ArithmeticChecker_GetResult__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_study_msgs, action, ArithmeticChecker_GetResult)() {
  return &ros_study_msgs::action::typesupport_fastrtps_cpp::_ArithmeticChecker_GetResult__handle;
}
...
// functions for ros_study_msgs::action::ArithmeticChecker_Feedback already declared above
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ros_study_msgs
cdr_serialize(
  const ros_study_msgs::action::ArithmeticChecker_FeedbackMessage & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ros_study_msgs::action::ArithmeticChecker_FeedbackMessage & ros_message)
{
  // Member: goal_id
  unique_identifier_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
    cdr, ros_message.goal_id);
  ...
  size_t current_alignment)
{
  ...
  // Member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ros_study_msgs::action::typesupport_fastrtps_cpp::max_serialized_size_ArithmeticChecker_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros_study_msgs::action::ArithmeticChecker_FeedbackMessage;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ros_study_msgs::action::ArithmeticChecker_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ros_study_msgs::action::ArithmeticChecker_FeedbackMessage *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ros_study_msgs::action::typesupport_fastrtps_cpp::_ArithmeticChecker_FeedbackMessage__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros_study_msgs, action, ArithmeticChecker_FeedbackMessage)() {
  return &ros_study_msgs::action::typesupport_fastrtps_cpp::_ArithmeticChecker_FeedbackMessage__handle;
}
