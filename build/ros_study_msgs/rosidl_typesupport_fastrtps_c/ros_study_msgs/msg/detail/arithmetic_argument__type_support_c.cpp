...
#include "ros_study_msgs/msg/detail/arithmetic_argument__rosidl_typesupport_fastrtps_c.h"
...
using _ArithmeticArgument__ros_msg_type = ros_study_msgs__msg__ArithmeticArgument;
...
size_t get_serialized_size_ros_study_msgs__msg__ArithmeticArgument(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ArithmeticArgument__ros_msg_type * ros_message = static_cast<const _ArithmeticArgument__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ArithmeticArgument__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_study_msgs__msg__ArithmeticArgument(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_study_msgs
size_t max_serialized_size_ros_study_msgs__msg__ArithmeticArgument(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_study_msgs__msg__ArithmeticArgument;
    is_plain =
      (
...
static size_t _ArithmeticArgument__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_study_msgs__msg__ArithmeticArgument(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_study_msgs, msg, ArithmeticArgument)() {
