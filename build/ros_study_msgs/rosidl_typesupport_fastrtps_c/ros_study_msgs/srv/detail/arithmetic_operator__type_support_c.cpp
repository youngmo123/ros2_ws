...
#include "ros_study_msgs/srv/detail/arithmetic_operator__rosidl_typesupport_fastrtps_c.h"
...
using _ArithmeticOperator_Request__ros_msg_type = ros_study_msgs__srv__ArithmeticOperator_Request;
...
size_t get_serialized_size_ros_study_msgs__srv__ArithmeticOperator_Request(
  const void * untyped_ros_message,
...
static uint32_t _ArithmeticOperator_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_study_msgs__srv__ArithmeticOperator_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_study_msgs
size_t max_serialized_size_ros_study_msgs__srv__ArithmeticOperator_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = ros_study_msgs__srv__ArithmeticOperator_Request;
    is_plain =
      (
...
static size_t _ArithmeticOperator_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_study_msgs__srv__ArithmeticOperator_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_study_msgs, srv, ArithmeticOperator_Request)() {
...
using _ArithmeticOperator_Response__ros_msg_type = ros_study_msgs__srv__ArithmeticOperator_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_study_msgs
size_t get_serialized_size_ros_study_msgs__srv__ArithmeticOperator_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ArithmeticOperator_Response__ros_msg_type * ros_message = static_cast<const _ArithmeticOperator_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_ros_study_msgs__srv__ArithmeticOperator_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ros_study_msgs
size_t max_serialized_size_ros_study_msgs__srv__ArithmeticOperator_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = ros_study_msgs__srv__ArithmeticOperator_Response;
    is_plain =
      (
...
static size_t _ArithmeticOperator_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ros_study_msgs__srv__ArithmeticOperator_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_study_msgs, srv, ArithmeticOperator_Response)() {
...
// already included above
// #include "ros_study_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "ros_study_msgs/srv/arithmetic_operator.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ros_study_msgs, srv, ArithmeticOperator)() {
