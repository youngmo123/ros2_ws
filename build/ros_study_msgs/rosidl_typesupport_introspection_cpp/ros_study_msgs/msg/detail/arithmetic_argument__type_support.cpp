...
{
  new (message_memory) ros_study_msgs::msg::ArithmeticArgument(_init);
}

void ArithmeticArgument_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ros_study_msgs::msg::ArithmeticArgument *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ArithmeticArgument_message_member_array[3] = {
  {
    ...
    offsetof(ros_study_msgs::msg::ArithmeticArgument, stamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros_study_msgs::msg::ArithmeticArgument, argument_a),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(ros_study_msgs::msg::ArithmeticArgument, argument_b),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ArithmeticArgument_message_members = {
  ...
  3,  // number of fields
  sizeof(ros_study_msgs::msg::ArithmeticArgument),
...
get_message_type_support_handle<ros_study_msgs::msg::ArithmeticArgument>()
{
  return &::ros_study_msgs::msg::rosidl_typesupport_introspection_cpp::ArithmeticArgument_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros_study_msgs, msg, ArithmeticArgument)() {
  return &::ros_study_msgs::msg::rosidl_typesupport_introspection_cpp::ArithmeticArgument_message_type_support_handle;
}
