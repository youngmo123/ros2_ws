...
static const _Progress_type_support_symbol_names_t _Progress_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, hangman_interfaces, msg, Progress)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, hangman_interfaces, msg, Progress)),
  }
};
...
{
  return &::hangman_interfaces::msg::rosidl_typesupport_cpp::Progress_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, hangman_interfaces, msg, Progress)() {
  return get_message_type_support_handle<hangman_interfaces::msg::Progress>();
}
